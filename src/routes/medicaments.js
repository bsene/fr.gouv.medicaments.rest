...
import { getData, getMetadata, searchInData } from "../services/dataLoader.js";
...
router.get("/search", (req, res) => {
  ...
  const specialites = searchInData(getData("specialites"), q, [
    "denomination",
    "forme_pharma",
    "titulaire",
  ]);
  const presentations = searchInData(getData("presentations"), q, ["libelle"]);
  const compositions = searchInData(getData("compositions"), q, [
